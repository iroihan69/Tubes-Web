...
<body>
    ...
    <!-- Hero Section -->
    <section class="hero">
        <img src="./assets/seal/seal-product-banner.webp" alt="BYD Hero" class="hero-image">
    </section>

    <section class="hero">
        <img src="./assets/seal/product-seal-design.jpg" alt="BYD Hero" class="hero-image">
    </section>

    <section class="hero">
        <img src="./assets/seal/3.jpg" alt="BYD Hero" class="hero-image">
    </section>

    <section class="hero">
        <img src="./assets/seal/4.jpg" alt="BYD Hero" class="hero-image">
    </section>

    <section class="hero">
        <img src="./assets/seal/10.jpg" alt="BYD Hero" class="hero-image">
    </section>
