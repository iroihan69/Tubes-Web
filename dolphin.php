...
<body>
    ...
    <!-- Hero Section -->
    <section class="hero">
        <img src="./assets/dolphin/product-dolphin-web.jpg" alt="BYD Hero" class="hero-image">
    </section>

    <section class="hero">
        <img src="./assets/dolphin/product-dolphin-design.jpg" alt="BYD Hero" class="hero-image">
    </section>

    <section class="hero">
        <img src="./assets/dolphin/3.jpg" alt="BYD Hero" class="hero-image">
    </section>

    <section class="hero">
        <img src="./assets/dolphin/5.jpg" alt="BYD Hero" class="hero-image">
    </section>

    <section class="hero">
        <img src="./assets/dolphin/9.jpg" alt="BYD Hero" class="hero-image">
    </section>
