...
<body>
    ...
    <!-- Hero Section -->
    <section class="hero">
        <img src="./assets/atto3/1.jpg" alt="BYD Hero" class="hero-image">
    </section>
    <section class="hero">
        <img src="./assets/atto3/depan-atto3.jpg" alt="BYD Hero" class="hero-image">
    </section>

    <section class="hero">
        <img src="./assets/atto3/atto3-worldclass-design.jpg" alt="BYD Hero" class="hero-image">
    </section>

    <section class="hero">
        <img src="./assets/atto3/rangka.jpg" alt="BYD Hero" class="hero-image">
    </section>

    <section class="hero">
        <img src="./assets/atto3/4.jpg" alt="BYD Hero" class="hero-image" style="margin-bottom: 50px">
    </section>
